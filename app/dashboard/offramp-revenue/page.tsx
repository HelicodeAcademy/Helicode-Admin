...
export default function OfframpRevenuePage() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      description: "Fees still pending collection",
    },
    {
  ...
  return (
    <main className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Offramp Revenue</h1>
          <p className="mt-2 text-gray-600">
            Developer fee collected from team and company cash-outs
          </p>
        </div>
            ...
            <Card key={source.key} className="border border-gray-200 bg-white">
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                <div className="flex items-center justify-between text-xs text-gray-500 pt-1">
                  <span>
                    Settled: {source.data?.settledTransferCount ?? 0}
                  </span>
                  <span>
                    Pending: {source.data?.pendingTransferCount ?? 0}
                  </span>
                </div>
              </CardContent>
            </Card>
        ...
        <Card className="border border-gray-200 bg-white mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Revenue status filters the list only. Totals still respect
              company, source, provider, and date range.
            </CardDescription>
          </CardHeader>

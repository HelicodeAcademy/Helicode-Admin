...
const STATUS_OPTIONS: Array<{ label: string; value: PayrollTransferStatus | "" }> =
  [
    { label: "All", value: "" },
...
export default function PayrollRevenuePage() {
  ...
  return (
    <main className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Payroll Revenue</h1>
          <p className="mt-2 text-gray-600">
            Developer fee collected from company payroll transfers
          </p>
        </div>
        ...
        <Card className="border border-gray-200 bg-white mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Status filters the transfer list only. Revenue totals still
              respect company and date range.
            </CardDescription>
          </CardHeader>
